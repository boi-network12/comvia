...
//   // ✅ Use ref to track if handlers are registered
//   // const handlersRegisteredRef = useRef(false);
//   // ✅ Use ref to track if socket is connected to prevent duplicate messages
//   const processedMessagesRef = useRef<Set<string>>(new Set());

//   // ✅ Memoize the message handlers so they don't change on every render
//   const handleMessage = useCallback((message: Message) => {
//     console.log('📨 [WIDGET] New message from socket:', message);

//     // ✅ Check if message already exists in the UI to prevent duplicates
//     // We check by content + sender + approximate time
...
//     // ✅ Check if this agent message was already processed
...
//   // ✅ Get socket with handlers - but only register handlers once
//   const {
...
//   // ✅ Only connect once
//   useEffect(() => {
//     if (!connectionInitiatedRef.current && !socketConnected && !isLoading && companyId) {
//       connectionInitiatedRef.current = true;
//       console.log('🔌 [WIDGET] Initiating socket connection...');
//       connectSocket();
//     }
//   }, [socketConnected, isLoading, companyId, connectSocket]);
...
//     }
//   }, [socketConnected, isLoading, connectSocket]);
